...
export default function NewWithdrawalPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    if (typeof navigator !== "undefined" && !navigator.onLine) { toast.error("An internet connection is required to process withdrawals."); return }
    setLoading(true)
    ...
    <div className="max-w-2xl mx-auto space-y-6 w-full max-w-full overflow-hidden">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Mobile money withdrawal to cash</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Who is withdrawing money?</CardDescription>
          </CardHeader>
        ...
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>Mobile money provider and wallet details</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
        ...
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>Withdrawal amount and currency</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
