...
const publicRoutes = ["/login", "/signup", "/track", "/forgot-password", "/api/auth", "/api/public", "/", "/features", "/pricing", "/about", "/contact", "/tutorials", "/exchange-rates", "/help", "/privacy", "/terms", "/api/public/stats", "/offline", "/sw.js", "/manifest.json", "/images"]
