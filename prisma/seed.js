...
async function main() {
  ...
  const plans = await Promise.all([
    prisma.subscriptionPlan.create({ data: { name: 'Small Company', description: 'For small money transfer businesses', price: 10, currency: 'USD', durationDays: 30, features: ['Up to 2 Branches', 'Up to 5 Staff Users', 'Basic Money Transfers', 'Customer Management', 'Basic Reports', 'Email Support', 'Secure Cloud Hosting', 'Branch Wallets', 'Advanced Compliance', 'API Access', 'Custom Branding', 'Up to 2 Active Currencies'], isActive: true } }),
    prisma.subscriptionPlan.create({ data: { name: 'Medium Company', description: 'For growing remittance agencies', price: 30, currency: 'USD', durationDays: 30, features: ['Up to 10 Branches', 'Up to 25 Staff Users', 'Unlimited Transfers', 'Branch Wallets', 'KYC & Compliance', 'Advanced Reports', 'Priority Email & Chat Support', 'Branch Performance Analytics', 'Audit Logs', 'Basic API Access', 'Custom Branding', 'Up to 6 Active Currencies'], isActive: true } }),
    prisma.subscriptionPlan.create({ data: { name: 'Enterprise', description: 'For large-scale financial institutions', price: 60, currency: 'USD', durationDays: 30, features: ['Unlimited Branches', 'Unlimited Staff Users', 'Unlimited Transfers', 'Branch Wallets', 'Advanced KYC/AML', 'Advanced Analytics', 'Custom Reports', '24/7 Dedicated Support', 'Dedicated Account Manager', 'Priority Processing', 'Full API Access', 'Custom Integrations', 'Custom Branding & Domain', 'Enterprise Security Features', 'Unlimited Currencies'], isActive: true } }),
  ]);
